...
tags: [systeme, journaux, logs, systemd]
---
...
| `-p`            | Filtrer par priorite (emerg, alert, crit, err) |
| `--since`       | Afficher les messages depuis une date          |
| `--until`       | Afficher les messages jusqu'a une date         |
| `-b`            | Afficher les messages du demarrage courant     |
| `--disk-usage`  | Afficher l'espace disque utilise par les logs  |
...
### Afficher l'espace disque utilise par les journaux
...
### Consulter les messages du dernier demarrage
