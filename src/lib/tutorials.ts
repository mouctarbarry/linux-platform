...
import { getContentItems, getContentBySlug, getAllSlugsFromDir } from './content';
...
export function getTutorials(): TutorialMeta[] {
  return getContentItems(TUTORIALS_DIR, transform).sort((a, b) => a.order - b.order);
}

export function getTutorialBySlug(slug: string): ContentItem<TutorialMeta> | undefined {
